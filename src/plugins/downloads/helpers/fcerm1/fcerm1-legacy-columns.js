/**
 * FCERM1 legacy template — column definitions
 *
 * Each entry has:
 ...
 *                        in FCERM1_YEARS passed to the builder (default false)
...
export const LEGACY_COLUMNS = [
  ...
  { column: 'S', field: 'floodProtectionAfter', condition: protectsHouseholds },
  {
    column: 'T',
  ...
  { column: 'CI', field: 'assetReplacementAllowance', dateRange: true },

  // Environment statutory funding CS-DB
  { column: 'CS', field: 'environmentStatutoryFunding', dateRange: true },

  // Frequently flooded communities DC-DL
  { column: 'DC', field: 'frequentlyFloodedCommunities', dateRange: true },

  // Other additional GiA DM-DV
  { column: 'DM', field: 'otherAdditionalGrantInAid', dateRange: true },

  // Other government department DW-EF
  { column: 'DW', field: 'otherGovernmentDepartment', dateRange: true },

  // Recovery EG-EP
  { column: 'EG', field: 'recovery', dateRange: true },

  // Summer economic fund EQ-EZ
  { column: 'EQ', field: 'summerEconomicFund', dateRange: true },

  // Local levy FA-FJ
  { column: 'FA', field: 'localLevy', dateRange: true },

  // Internal drainage boards FK-FT
  { column: 'FK', field: 'internalDrainageBoards', dateRange: true },

  // Public contributions FU-GD
  { column: 'FU', field: 'publicContributions', dateRange: true },

  // Private contributions GE-GN
  { column: 'GE', field: 'privateContributions', dateRange: true },

  // Other EA contributions GO-GX
  { column: 'GO', field: 'otherEaContributions', dateRange: true },
  ...
  // ── NFM habitats MI-MV ───────────────────────────────────────────────────
  { column: 'MI', field: 'hectaresOfIntertidalHabitatCreatedOrEnhanced' },
  { column: 'MJ', field: 'hectaresOfWoodlandHabitatCreatedOrEnhanced' },
  { column: 'MK', field: 'hectaresOfWetWoodlandHabitatCreatedOrEnhanced' },
  { column: 'ML', field: 'hectaresOfWetlandOrWetGrasslandCreatedOrEnhanced' },
  { column: 'MM', field: 'hectaresOfGrasslandHabitatCreatedOrEnhanced' },
  { column: 'MN', field: 'hectaresOfHeathlandCreatedOrEnhanced' },
  { column: 'MO', field: 'hectaresOfPondOrLakeHabitatCreatedOrEnhanced' },
  { column: 'MP', field: 'hectaresOfArableLandLakeHabitatCreatedOrEnhanced' },
  {
    column: 'MQ',
    field: 'kilometresOfWatercourseEnhancedOrCreatedComprehensive'
  },
  { column: 'MR', field: 'kilometresOfWatercourseEnhancedOrCreatedPartial' },
  { column: 'MS', field: 'kilometresOfWatercourseEnhancedOrCreatedSingle' },
  ...
  { column: 'MY', field: 'confidenceSecuredPartnershipFunding' },
