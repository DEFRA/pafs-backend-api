...
describe('AccountService', () => {
  ...
  describe('disableInactiveAccounts', () => {
    ...
    it('should handle accounts with null current_sign_in_at', async () => {
  ...
  describe('reactivateAccount', () => {
    ...
    it('should reset current_sign_in_at to prevent immediate re-disable on login or by nightly scheduler', async () => {
      const disabledUser = {
        id: BigInt(1),
        email: 'user@example.com',
        first_name: 'John',
